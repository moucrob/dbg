...
if("TRUE" STREQUAL "TRUE")
  set(rosbook_arm_controller_configuration_SOURCE_PREFIX /home/mathias/try/catkin_ws/src/rosbook_arm_controller_configuration)
  set(rosbook_arm_controller_configuration_DEVEL_PREFIX /home/mathias/try/catkin_ws/devel)
  ...
  set(rosbook_arm_controller_configuration_INSTALL_PREFIX /home/mathias/try/catkin_ws/install)
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      if(NOT IS_DIRECTORY ${include})
        message(FATAL_ERROR "Project 'rosbook_arm_controller_configuration' specifies '${idir}' as an include dir, which is not found.  It does not exist in '${include}'.  ${_report}")
      endif()
    else()
      message(FATAL_ERROR "Project 'rosbook_arm_controller_configuration' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/mathias/try/catkin_ws/src/rosbook_arm_controller_configuration/${idir}'.  ${_report}")
    endif()
...
foreach(depend ${depends})
  ...
  if(${count} EQUAL 1)
    ...
    if(NOT ${rosbook_arm_controller_configuration_dep}_FOUND)
      find_package(${rosbook_arm_controller_configuration_dep} REQUIRED NO_MODULE)
    endif()
  else()
    # dependencies with components must be find_package()-ed again
    list(REMOVE_AT depend_list 0)
    find_package(${rosbook_arm_controller_configuration_dep} REQUIRED NO_MODULE ${depend_list})
  endif()
